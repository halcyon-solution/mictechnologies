...
const ContactHeroSection = () => {
  ...
  return (
    <section className="relative z-0 text-white font-poppins py-20">
              ...
              <div className="flex flex-col gap-6">
                {contactInfo.map((info, index) => (
                  <div key={index} className="flex gap-4 group">
                    <div className="w-12 h-12 shrink-0 bg-[#FF006E] rounded-xl flex items-center justify-center text-white group-hover:scale-110 transition-all duration-300 shadow-lg">
                      {info.icon}
                    </div>
